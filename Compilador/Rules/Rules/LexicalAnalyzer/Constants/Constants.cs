namespace Rules.LexicalAnalyzer.Constants
{
    public abstract class Constants : ScannerConstants
    {
        ...
        public const int t_and = 7;
        public const int t_begin = 8;
        public const int t_bool = 9;
        public const int t_char = 10;
        public const int t_end = 11;
        public const int t_false = 12;
        public const int t_float = 13;
        public const int t_forward = 14;
        public const int t_ifFalseDo = 15;
        public const int t_ifTrueDo = 16;
        public const int t_int = 17;
        public const int t_main = 18;
        public const int t_module = 19;
        public const int t_not = 20;
        public const int t_or = 21;
        public const int t_read = 22;
        public const int t_string = 23;
        public const int t_true = 24;
        public const int t_void = 25;
        public const int t_whileFalseDo = 26;
        public const int t_whileTrueDo = 27;
        public const int t_write = 28;
